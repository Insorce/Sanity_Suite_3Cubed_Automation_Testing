...
public class Brokenlink_Volume_Page extends Baseclass {

	@Test
	public void PageBreaks_Volume_Page() throws Exception {
		//WebDriver driver= new ChromeDriver();
				...
				click_input_button.executeScript("arguments[0].click();", input_button);
			     ...
			     //click on Systems_Applications
			       WebElement Volume_Page=driver.findElement(By.xpath("//a[@href='/Process/Volume']"));
					JavascriptExecutor Volume = (JavascriptExecutor)driver;
					Volume.executeScript("arguments[0].click();", Volume_Page);
