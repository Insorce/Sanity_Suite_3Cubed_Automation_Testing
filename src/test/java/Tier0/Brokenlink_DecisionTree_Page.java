...
public class Brokenlink_DecisionTree_Page extends Baseclass{

	@Test
	public void PageBreaks_DecisionTree_Page() throws Exception {
		//WebDriver driver= new ChromeDriver();
				...
				//click on  DecisionTree button
				Thread.sleep(7000);
				WebElement DecisionTree_button=driver.findElement(By.xpath("//a[@href='/Projects/DecisionTree?Pid=5519']"));
				JavascriptExecutor click_input_button = (JavascriptExecutor)driver;
				click_input_button.executeScript("arguments[0].click();", DecisionTree_button);
