...
public class Brokenlinks_GeolocateWorkingHours_Page extends Baseclass{
	@Test
	public void PageBreaks_GeolocateWorkingHours_Page() throws Exception {
		//WebDriver driver= new ChromeDriver();
				...
				//click on GeolocateWorkingHours
			       WebElement GeolocateWorkingHours=driver.findElement(By.xpath("//a[@href='/Process/GeolocateWorkingHours']"));
					JavascriptExecutor GeolocateWorking = (JavascriptExecutor)driver;
					GeolocateWorking.executeScript("arguments[0].click();", GeolocateWorkingHours);
