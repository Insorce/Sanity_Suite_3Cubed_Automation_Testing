...
public class Brokenlink_Product_Page extends Baseclass {
		...
		//WebDriver driver= new ChromeDriver();
				...
				click_input_button.executeScript("arguments[0].click();", input_button);
			     ...
			     //click on Systems_Applications
			       WebElement Products=driver.findElement(By.xpath("//a[@href='/Process/Product']"));
					JavascriptExecutor Product = (JavascriptExecutor)driver;
					Product.executeScript("arguments[0].click();", Products);
