...
public class Brokenlink_Model_Insight_Page extends Baseclass {
	
	@Test
	public void PageBreaks_Model_Insight_Page() throws Exception {
		//WebDriver driver= new ChromeDriver();
				...
				//click on  Model Insight button
				Thread.sleep(7000);
				WebElement Model_Insightt_button=driver.findElement(By.xpath("//a[@href='/Validation/Controls?Pid=5519&screen=modalval']"));
				JavascriptExecutor click_input_button = (JavascriptExecutor)driver;
				click_input_button.executeScript("arguments[0].click();", Model_Insightt_button);
