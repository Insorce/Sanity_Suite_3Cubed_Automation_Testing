...
public class Brokenlink_PeriodicActivities_Page extends Baseclass {

	@Test
	public void PageBreaks_PeriodicActivities_Page() throws Exception {
		//WebDriver driver= new ChromeDriver();
				...
				click_input_button.executeScript("arguments[0].click();", input_button);
			     ...
			     //click on Systems_Applications
			       WebElement PeriodicActivities=driver.findElement(By.xpath("//a[@href='/Process/PeriodicActivities']"));
					JavascriptExecutor PeriodicActivity = (JavascriptExecutor)driver;
					PeriodicActivity.executeScript("arguments[0].click();", PeriodicActivities);
