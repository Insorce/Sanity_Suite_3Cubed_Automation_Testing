...
public class Brokenlink_Systems_Applications_Page extends Baseclass{

	@Test
	public void PageBreaks_ProcessMap_Page() throws Exception {
		//WebDriver driver= new ChromeDriver();
				...
				click_input_button.executeScript("arguments[0].click();", input_button);
			     ...
			     //click on Systems_Applications
			       WebElement Systems_Applications=driver.findElement(By.xpath("//a[@href='/Process/SystemsandApplications']"));
					JavascriptExecutor SystemsApplications = (JavascriptExecutor)driver;
					SystemsApplications.executeScript("arguments[0].click();", Systems_Applications);
